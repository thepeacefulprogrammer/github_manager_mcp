...
This module provides logging configuration and utilities for the GitHub Project Manager MCP Server.
It supports environment-based configuration and provides standardized logging across the application.
"""
