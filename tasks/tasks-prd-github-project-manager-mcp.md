...
- `src/github_project_manager_mcp/utils/relationship_manager.py` - Hierarchical relationship management utilities for GitHub Project Manager MCP with RelationshipManager class providing validation, querying, and consistency checking for PRD-Task-Subtask relationships including parent-child validation, orphaned item detection, and comprehensive hierarchy analysis using GitHub Projects v2 API
- `tests/unit/utils/test_relationship_manager.py` - Unit tests for RelationshipManager utility with comprehensive TDD test coverage for relationship validation, hierarchical consistency checking, and parent-child querying functionality including validation result testing, GitHub API integration, and error handling (26 total tests)
...
- [ ] 4.0 Implement PRD and Task Management
  ...
  - [ ] 4.17 Create hierarchical relationship management between PRDs, tasks, and subtasks
    ...
    - [ ] 4.17.2 Implement cascade completion logic (auto-complete parent when all children complete)
    - [ ] 4.17.3 Implement hierarchical status synchronization and progress tracking
    - [ ] 4.17.4 Add enhanced relationship querying and filtering capabilities
    - [ ] 4.17.5 Implement dependency management and validation between levels
